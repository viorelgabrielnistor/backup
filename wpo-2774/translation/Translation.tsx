...
import { MANDATORY_TICKET_DETAILS, PROJECT_TYPES, WORKFLOWS } from '../../constants/project';
...
import MonacoComp from './MonacoComp';
...
const Translation: FC<ITranslationProps> = ({ ticketFormData }) => {
  ...
  const { loggedUserData: { preferredLanguage, selectedProject } } = useLoggedUserData();
