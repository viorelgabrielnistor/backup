...
import ImportStandardTextsModal from './ImportStandardTextsModal';
...
const StandardTextListing: FC<{}> = () => {
  ...
  const [showImportStandardTexts, setShowImportStandardTexts] = useState(false);
          ...
          (
            <>
              <Row>
                ...
                <Col className={ ` ${ styles.importButton } ml-auto mt-auto pl-0` }>
                  <button 
                    type="button"
                    disabled={ !!standardTexts && !standardTexts.length }
                    className={ styles.reorderBtn } 
                    onClick={ () => setShowImportStandardTexts(true) }
                  >
                    <FormattedMessage id="label.button.importStandardReplies" />
                  </button>
                </Col>
              </Row>
              <div className="mt-3">
              ...
              />
              <ImportStandardTextsModal
                client={ client }
                language={ language }
                show={ showImportStandardTexts }
                handleClose={ () => setShowImportStandardTexts(false) }
              />
            </>
          ) }
    </>
